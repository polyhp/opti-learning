...
@section('content')
    <div class="relative min-h-screen flex items-center justify-center py-8 px-3 sm:px-4 lg:px-8">
        ...
        <div class="relative w-full max-w-4xl">
            <div class="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden">
                <div class="grid md:grid-cols-2">
                    <!-- Left Panel - Branding (caché sur mobile) -->
                        ...
                        <div class="h-full flex flex-col justify-between">
                            <div>
                                ...
                                <p class="text-orange-100 mb-6">Accédez à des formations de qualité et développez vos
                                    compétences avec nos experts.</p>
                                <div class="space-y-4">
                            ...
                            <div class="mt-8">
                                <div class="border-t border-orange-400 pt-6">
                                    ...
                                    <a href="{{ route('login') }}"
                                        class="text-white font-semibold hover:text-orange-200 transition">
                    ...
                    <div class="bg-white">
                        ...
                        <div class="md:hidden bg-gradient-to-r from-orange-500 to-orange-600 p-5 text-white text-center">
                            ...
                            <p class="text-orange-100 text-sm">Rejoignez notre communauté d'apprenants</p>
                        </div>

                        <div class="p-5 sm:p-6 md:p-10">
                            <div class="mb-6 text-center md:text-left">
                                <h2 class="text-xl sm:text-2xl md:text-3xl font-bold text-navy-900 mb-2">Inscription
                                    Apprenant</h2>
                                <p class="text-sm text-gray-600">Créez votre compte et commencez votre apprentissage</p>
                            </div>
                            ...
                            <form method="POST" action="{{ route('register.apprenant') }}" class="space-y-5">
                                ...
                                <div class="grid md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select name="gender" required
                                            ...
                                            <option value="male" {{ old('gender') == 'male' ? 'selected' : '' }}>Homme
                                            </option>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="terms" class="ml-2 text-sm text-gray-600">
                                        J'accepte les <a href="#" class="text-orange-500 hover:text-orange-600">conditions
                                            générales d'utilisation</a>
                                    </label>
                                </div>

                                <button type="submit"
                                    class="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold py-3 px-4 rounded-lg hover:from-orange-600 hover:to-orange-700 transition duration-300 transform hover:scale-[1.02] shadow-lg">
    ...
    <style>
        /* Animation subtile pour la bande orange */
