  ...
  <section class="search-section">
    <div class="container">
      <div class="search-hero-text">
        ...
        <p>Plusieurs formations disponibles · Paiement Mobile Money accepté</p>
      </div>
      <form action="{{ route('home') }}" method="GET" class="search-bar">
        <div class="search-icon-wrap">
          <svg width="18" height="18" fill="none" viewBox="0 0 24 24" stroke="#8896AE" stroke-width="2"
            stroke-linecap="round">
        ...
        <input class="search-input" type="text" name="search" value="{{ request('search') }}"
          placeholder="Ex : Excel, Python, Marketing Digital…" id="searchInput">
    ...
    <section class="all-courses-section" style="padding-top: 40px; min-height: 60vh;">
      <div class="container">
        <div class="section-header">
          <div>
            ...
            <h2 class="section-title">
              ...
              @elseif(request('category'))
                Catégorie : <span
                  class="accent">{{ $categories->firstWhere('id', request('category'))->name ?? 'Sélectionnée' }}</span>
              @else
          ...
          <a href="{{ route('home') }}" class="see-all"
            style="background:#F4F6FB; padding:8px 16px; border-radius:20px; color:#122255;">
            <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"
              stroke-linecap="round" style="transform: rotate(180deg); margin-right:4px;">
        ...
        @if($searchResults->count() > 0)
          <div class="courses-wrapper">
            <button class="scroll-btn scroll-btn-left" aria-label="Précédent"
              ...
              @foreach($searchResults as $course)
                <div class="course-card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="card-instructor"><span class="instructor-dot"></span>Par
                      {{ $course->formateur->user->first_name ?? 'Inconnu' }}
                    </div>
                    <div class="card-meta">
                    ...
                    <div class="card-footer">
                      ...
                      <a href="{{ route('courses.show', $course->id) }}" class="btn-voir"
                        style="display: inline-block; text-align: center;">Voir</a>
                    </div>
                  </div>
                </div>
              @endforeach
            </div>
            <button class="scroll-btn scroll-btn-right" aria-label="Suivant"
          ...
          @if ($searchResults->hasPages())
            <div style="margin-top: 40px; display: flex; justify-content: center; gap: 10px;">
              @if ($searchResults->onFirstPage())
                <span
                  style="padding: 8px 16px; background: #eee; border-radius: 8px; color: #888; cursor: not-allowed; opacity: 0.6;">Précédent</span>
              @else
                <a href="{{ $searchResults->previousPageUrl() }}"
                  style="padding: 8px 16px; background: var(--orange); color: white; border-radius: 8px; font-weight: bold; transition: background 0.2s;">Précédent</a>
              @endif

              @if ($searchResults->hasMorePages())
                <a href="{{ $searchResults->nextPageUrl() }}"
                  style="padding: 8px 16px; background: var(--orange); color: white; border-radius: 8px; font-weight: bold; transition: background 0.2s;">Suivant</a>
              @else
                <span
                  style="padding: 8px 16px; background: #eee; border-radius: 8px; color: #888; cursor: not-allowed; opacity: 0.6;">Suivant</span>
              @endif
            </div>
          @endif
        ...
        @else
          <div
            style="text-align: center; padding: 60px 20px; background: #F4F6FB; border-radius: 20px; border: 1px dashed #ccc;">
            <svg style="width: 64px; height: 64px; margin: 0 auto 16px; color: #8896AE;" fill="none" viewBox="0 0 24 24"
              stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <h3 style="font-size: 20px; font-weight: bold; color: var(--navy); margin-bottom: 8px;">Aucune formation trouvée
            </h3>
            <p style="color: var(--gray-text);">Essayez de modifier vos critères de recherche ou de changer de catégorie.
            </p>
    ...
    <section class="carousel-section" id="formations">
      <div class="container">
        <div class="section-header">
          ...
          <a href="{{ route('home', ['all' => 1]) }}" class="see-all">Tout voir <svg width="14" height="14" fill="none"
              ...
              <div class="course-card">
                ...
                <div class="card-body">
                  ...
                  <div class="card-footer">
                    ...
                    <a href="{{ route('courses.show', $course->id) }}" class="btn-voir"
                      style="display: inline-block; text-align: center;">Voir la formation</a>
                  </div>
                </div>
              </div>
            @empty
    ...
    <section class="all-courses-section">
      <div class="container">
        <div class="section-header">
          ...
          <a href="{{ route('home', ['all' => 1]) }}" class="see-all">Voir tout le catalogue <svg width="14" height="14"
              fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5" stroke-linecap="round">
              <path d="M5 12h14M12 5l7 7-7 7" />
            </svg></a>
        </div>
        <div class="courses-wrapper">
              ...
              <div class="mini-card relative" style="position: relative;">
                ...
                <div class="mini-body">
                  ...
                  <div class="mini-footer" style="display:flex; flex-direction: column; align-items:flex-start; gap: 4px;">
                    ...
                    <span class="mini-stars text-orange-500 font-bold" style="font-size:12px;"><i class="fas fa-users"
                        style="margin-right:2px;"></i> {{ $course->orders_count }} inscrit(s)</span>
                  </div>
                </div>
              </div>
            @empty
              <div class="col-span-full text-center text-gray-500 py-8" style="grid-column: 1 / -1;">Aucune formation pour
                l'instant.</div>
            @endforelse
      ...
      <div class="stats-inner">
        <div class="stats-text">
          ...
          <p>Des formations conçues pour l'Afrique, accessibles depuis votre smartphone. Payez avec MTN Money, Moov
            Money, Celtiis Cash ou Carte Bancaire . Apprenez à votre rythme.</p>
          <div class="stats-features">
            <div class="feature-item">
              <div class="feature-check"><svg viewBox="0 0 24 24">
            ...
            <div class="feature-item">
              ...
              Paiement Mobile Money (MTN, Moov, Celtiis ) et par Carte Bancaire
            </div>
            <div class="feature-item">
              <div class="feature-check"><svg viewBox="0 0 24 24">
                  <polyline points="20 6 9 17 4 12" />
      ...
      <div class="footer-grid">
        ...
        <div class="footer-brand">
          ...
          <p class="footer-desc">La plateforme de formation en ligne pensée pour l'Afrique. Des cours certifiants
            accessibles depuis votre téléphone, payables par Mobile Money.</p>
          <div class="payment-badges">
            <span class="pay-badge">MTN Money</span>
            <span class="pay-badge">Moov Money</span>
            <span class="pay-badge">Celtiis Cash</span>
          ...
          <div class="social-links">
            ...
            <button class="social-btn" title="YouTube">
              <svg viewBox="0 0 24 24">
                <path
                  d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.95C18.88 4 12 4 12 4s-6.88 0-8.59.47A2.78 2.78 0 0 0 1.46 6.42 29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.95 1.95C5.12 20 12 20 12 20s6.88 0 8.59-.47a2.78 2.78 0 0 0 1.95-1.95A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z" />
                <polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" style="fill:#060E24" />
              </svg>
            </button>
            <!-- WhatsApp -->
            ...
            <button class="social-btn" title="Instagram">
              <svg viewBox="0 0 24 24">
                ...
                <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" style="fill:#060E24" />
                <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"
                  style="stroke:#060E24;stroke-width:2;stroke-linecap:round" />
              </svg>
            </button>
          </div>
        </div>
