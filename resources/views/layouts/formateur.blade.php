...
<body class="text-slate-800 antialiased min-h-screen flex flex-col overflow-x-clip">
    ...
    <!-- Main Unified Navbar -->
    <x-navbar :showSidebarToggle="false" :showProfile="true" :searchAction="route('formateur.catalog')" />
        ...
        <div
            ...
            <div class="mt-6 flex flex-col sm:flex-row gap-3">
                ...
                <button onclick="closeProfileModal()"
                    class="flex-1 bg-navy-900 hover:bg-navy-800 text-white py-2 rounded-xl transition-colors border border-navy-800">
                    Fermer
                </button>
            </div>
        </div>
